...
func TestGetURLLabel(t *testing.T) {
	for i, tt := range []struct {
		...
		{"https://archive.softwareheritage.org/browse/origin/directory/?origin_url=https://bitbucket.org/lifthrasiir/esotope-ws", "Bitbucket (git archive)"},
		{"https://sourceforge.net/projects/esco/", "SourceForge"},
		{"https://git.code.sf.net/p/esco/code", "SourceForge"},
		{"http://esco.sourceforge.net/", "SourceForge site"},
		{"https://web.archive.org/web/20160114185408/https://code.google.com/p/grass-mud-horse/", "Google Code (archive)"},
		{"https://web.archive.org/web/20210624084916/https://code.google.com/archive/p/grass-mud-horse/", "Google Code (archive)"},
		{"https://archive.softwareheritage.org/browse/origin/directory/?origin_url=http://grass-mud-horse.googlecode.com/svn/", "Google Code (git archive)"},
		{"https://hackage.haskell.org/package/whitespace-0.4", "Hackage"},
		{"https://vii5ard.github.io/whitespace/", "GitHub Pages"},
		...
		{"https://www.webarchive.org.uk/wayback/archive/20130413180125/http://compsoc.dur.ac.uk/whitespace/index.php", "Durham CompSoc (archive)"},
		...
		{"http://pelangchallenge.blogspot.com/2013/09/problem-36-done-in-whitespace.html", "Blogger"},
		...
		{"https://web.archive.org/web/20130510111931/https://sites.google.com/site/res0001/whitespace/programs", "Google Sites (archive)"},
