...
func TestGetURLLabel(t *testing.T) {
	for i, tt := range []struct {
		...
		{"https://archive.softwareheritage.org/browse/origin/directory/?origin_url=https://bitbucket.org/lifthrasiir/esotope-ws", "Bitbucket (archive)"},
		...
		{"https://archive.softwareheritage.org/browse/origin/directory/?origin_url=http://grass-mud-horse.googlecode.com/svn/", "Google Code (archive)"},
